...
namespace FoodSafe.Migrations
{
    ...
    [Migration("20260730203720_AddOrganizationScopeToManagementScopeAssignment")]
    partial class AddOrganizationScopeToManagementScopeAssignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodSafe.BusinessManagement.Business", b =>
                {
                    ...
                    b.HasIndex("AddressCommuneId", "AddressProvinceId");

                    b.ToTable("businesses", null, t =>
                        {
                            t.HasCheckConstraint("chk_businesses_address_chain", "address_commune_id IS NULL OR address_province_id IS NOT NULL");
            ...
            modelBuilder.Entity("FoodSafe.FoodPoisoning.PoisoningCaseVictim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("poisoning_case_victims", (string)null);
                });
            ...
            modelBuilder.Entity("FoodSafe.Inspection.InspectionResult", b =>
                {
                    ...
                    b.Property<string>("FollowUpScope")
                        .HasColumnType("text")
                        .HasColumnName("follow_up_scope");
            ...
            modelBuilder.Entity("FoodSafe.Notifications.AppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RecipientUserId", "CreationTime")
            ...
            modelBuilder.Entity("FoodSafe.Security.ManagementScopeAssignment", b =>
                {
                    ...
                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("idx_msa_scope_org");
                    ...
                    b.ToTable("management_scope_assignments", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_msa_type", "scope_type IN (1, 2, 3, 4, 5)");
                        });
                });
            ...
            modelBuilder.Entity("FoodSafe.BusinessManagement.Business", b =>
                {
                    ...
                    b.HasOne("FoodSafe.Catalogs.Commune", null)
                        .WithMany()
                        .HasForeignKey("AddressCommuneId", "AddressProvinceId")
                        .HasPrincipalKey("Id", "ProvinceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_businesses_commune_province");
                });
            ...
            modelBuilder.Entity("FoodSafe.Catalogs.Commune", b =>
                {
                    b.HasOne("FoodSafe.Catalogs.Province", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_cat_communes_province");
                });
            ...
            modelBuilder.Entity("FoodSafe.Catalogs.TestingCenter", b =>
                {
                    ...
                    b.HasOne("FoodSafe.Catalogs.Commune", null)
                        .WithMany()
                        .HasForeignKey("CommuneId", "ProvinceId")
                        .HasPrincipalKey("Id", "ProvinceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_testing_centers_commune_province");
                });
            ...
            modelBuilder.Entity("FoodSafe.Security.ManagementScopeAssignment", b =>
                {
                    ...
                    b.HasOne("FoodSafe.Organizations.Organization", null)
                        ...
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_msa_scope_org");
