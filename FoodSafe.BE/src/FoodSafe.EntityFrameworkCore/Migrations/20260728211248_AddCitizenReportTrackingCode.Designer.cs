...
namespace FoodSafe.Migrations
{
    ...
    [Migration("20260728211248_AddCitizenReportTrackingCode")]
    partial class AddCitizenReportTrackingCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("atp_alerts", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_alerts_publish", "status IN (1, 4) OR (published_by_id IS NOT NULL AND published_at IS NOT NULL)");
                            ...
                            t.HasCheckConstraint("chk_alerts_reject", "status <> 4 OR (rejected_by_id IS NOT NULL AND rejected_at IS NOT NULL AND rejected_reason IS NOT NULL)");

                            t.HasCheckConstraint("chk_alerts_severity", "severity IN (1, 2, 3, 4)");

                            t.HasCheckConstraint("chk_alerts_source", "source IN (1, 2, 3)");

                            t.HasCheckConstraint("chk_alerts_status", "status IN (1, 2, 3, 4)");
                        });
                });
            ...
            modelBuilder.Entity("FoodSafe.AlertsAndTesting.AtpNews", b =>
                {
                    ...
                    b.ToTable("atp_news", null, t =>
                        {
                            t.HasCheckConstraint("chk_news_publish", "status IN (1, 4) OR (published_by_id IS NOT NULL AND published_at IS NOT NULL)");

                            t.HasCheckConstraint("chk_news_recall", "status <> 3 OR (recalled_by_id IS NOT NULL AND recalled_at IS NOT NULL)");

                            t.HasCheckConstraint("chk_news_reject", "status <> 4 OR (rejected_by_id IS NOT NULL AND rejected_at IS NOT NULL AND rejected_reason IS NOT NULL)");

                            t.HasCheckConstraint("chk_news_status", "status IN (1, 2, 3, 4)");
            ...
            modelBuilder.Entity("FoodSafe.DataIntegration.ApiSpecification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_di_api_specifications");
                    ...
                    b.HasIndex("OrganizationId", "Name", "VersionNumber")
                        .IsUnique()
                        .HasDatabaseName("uq_di_apispec_org_name_version")
                        .HasFilter("is_deleted = FALSE");

                    b.ToTable("di_api_specifications", (string)null);
                });

            modelBuilder.Entity("FoodSafe.DataIntegration.InboundSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_di_inbound_submissions");

                    b.HasIndex("OrganizationId", "ReceivedAt")
                        .HasDatabaseName("idx_di_is_org_received");

                    b.HasIndex("PartnerAccountId", "RequestId")
                        .IsUnique()
                        .HasDatabaseName("uq_di_is_partner_request");

                    b.ToTable("di_inbound_submissions", null, t =>
                        {
                            t.HasCheckConstraint("chk_di_is_disposition", "status = 1 OR (processed_by_id IS NOT NULL AND processed_at IS NOT NULL)");

                            t.HasCheckConstraint("chk_di_is_reject_reason", "status <> 3 OR reject_reason IS NOT NULL");

                            t.HasCheckConstraint("chk_di_is_status", "status IN (1, 2, 3)");
                        });
                });

            modelBuilder.Entity("FoodSafe.DataIntegration.PartnerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_di_partner_accounts");
                    ...
                    b.ToTable("di_partner_accounts", (string)null);
                });

            modelBuilder.Entity("FoodSafe.DataIntegration.PartnerApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_di_partner_api_keys");
                    ...
                    b.ToTable("di_partner_api_keys", (string)null);
                });
            ...
            modelBuilder.Entity("FoodSafe.FoodPoisoning.FoodPoisoningCase", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "CaseCode")
                        .IsUnique()
            ...
            modelBuilder.Entity("FoodSafe.FoodPoisoning.FoodPoisoningIncident", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "IncidentCode")
                        .IsUnique()
            ...
            modelBuilder.Entity("FoodSafe.DataIntegration.InboundSubmission", b =>
                {
                    b.HasOne("FoodSafe.DataIntegration.PartnerAccount", null)
                        .WithMany()
