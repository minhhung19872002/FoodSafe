...
public class CfsCertificateAttachmentAppService :
    ApplicationService,
    ICfsCertificateAttachmentAppService
{
    private readonly ICfsCertificateDataScopeChecker _scopeChecker;
    private readonly IDocumentAttachmentStore _store;
    private readonly IRepository<CfsCertificate, Guid> _registrations;

    public CfsCertificateAttachmentAppService(
        ICfsCertificateDataScopeChecker scopeChecker,
