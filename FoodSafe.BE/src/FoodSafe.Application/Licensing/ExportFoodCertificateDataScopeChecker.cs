...
public interface IExportFoodCertificateDataScopeChecker
{
...
public sealed class ExportFoodCertificateDataScopeChecker(
    ...
    IExportFoodCertificateDataScopeChecker,
