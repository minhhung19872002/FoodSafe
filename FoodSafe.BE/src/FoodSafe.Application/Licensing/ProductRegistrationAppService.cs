...
public class ProductRegistrationAppService :
    ApplicationService,
    IProductRegistrationAppService
{
    ...
    public ProductRegistrationAppService(
    ...
    public async Task<PagedResultDto<ProductRegistrationDto>> GetListAsync(
    ...
    public async Task<ProductRegistrationDto> GetAsync(Guid id)
    {
    ...
    [Authorize(FoodSafePermissions.Licensing.ProductRegistrations.Create)]
    public async Task<ProductRegistrationDto> CreateAsync(
    ...
    public async Task<ProductRegistrationDto> UpdateAsync(
        Guid id,
        UpdateProductRegistrationDto input)
    {
        ...
        if (input.BusinessId != registration.BusinessId)
            throw new BusinessException(
                FoodSafeDomainErrorCodes.ProductRegistration.ProductMismatch);
        var business = await GetScopedBusinessAsync(
    ...
    [Authorize(FoodSafePermissions.Licensing.ProductRegistrations.Delete)]
    ...
    [Authorize(FoodSafePermissions.Licensing.ProductRegistrations.Edit)]
    public async Task<ProductRegistrationDto> RevokeAsync(
        Guid id,
    ...
    private async Task<IQueryable<ProductRegistration>> ScopedQueryAsync(
    ...
    private async Task<ProductRegistration> GetScopedAsync(
        Guid id,
        DataScopeOperation operation)
    {
    ...
    private async Task<List<ProductRegistrationDto>> ToDtosAsync(
        IReadOnlyCollection<ProductRegistration> registrations,
        DateTime today)
    {
        ...
        {
            var dto = ObjectMapper.Map<ProductRegistration,
                ProductRegistrationDto>(x);
