...
[Authorize]
[Route("api/v1/app/product/excel")]
public sealed class ProductExcelController(
    IProductExcelAppService service) : AbpControllerBase
{
    ...
    public async Task<IActionResult> ExportAsync(
        [FromQuery] ProductListInput input)
    {
