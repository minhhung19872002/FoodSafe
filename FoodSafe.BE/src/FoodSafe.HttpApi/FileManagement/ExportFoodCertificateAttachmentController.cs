...
[Authorize]
[Route(
    "api/v1/app/export-food-certificate/{registrationId:guid}/attachments")]
public sealed class ExportFoodCertificateAttachmentController(
    IExportFoodCertificateAttachmentAppService service) : AbpControllerBase
{
