...
[Authorize]
[Route(
    "api/v1/app/product-registration/{registrationId:guid}/attachments")]
public sealed class ProductRegistrationAttachmentController(
    IProductRegistrationAttachmentAppService service) : AbpControllerBase
{
