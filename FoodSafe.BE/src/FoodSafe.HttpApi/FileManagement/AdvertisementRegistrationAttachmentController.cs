...
[Authorize]
[Route(
    "api/v1/app/advertisement-registration/{registrationId:guid}/attachments")]
public sealed class AdvertisementRegistrationAttachmentController(
    IAdvertisementRegistrationAttachmentAppService service) :
    AbpControllerBase
{
    ...
    public Task DeleteAsync(Guid registrationId, Guid attachmentId) =>
