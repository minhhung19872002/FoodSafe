...
public sealed class ActionMonthReportErrorNotification : Entity<Guid>
{
    ...
    private ActionMonthReportErrorNotification() { }

    internal ActionMonthReportErrorNotification(
