...
- **Commit**: `__PENDING__` (files: `CurrentUserContextAppService.cs`, `IdentityAdministrationAppService.cs`, `CurrentUserContextPermissionContractTests.cs`, `e2e/identity-user-lifecycle.spec.ts`, docs 73/77/03)
