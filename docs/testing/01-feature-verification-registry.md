...
- Total features: 32
- VERIFIED: **16** (F-002, F-006..F-019 — see `features/*.md`)
- READY_FOR_TEST: **16** (E2E specs pass against the real stack, but full verification checklist not yet executed per feature)
- FAILED: 0
