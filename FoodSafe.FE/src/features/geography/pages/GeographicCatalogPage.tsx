...
export default function GeographicCatalogPage() {
  ...
  const parentId = modal?.kind === 'district'
    ? provinceId
    : modal?.kind === 'commune'
      ? districtId
      : undefined
      ...
      columns={[
        ...
        ...(kind === 'province'
          ...
          : [{
              ...
              width: 140,
              render: (type: number) =>
                (kind === 'district' ? districtTypes : communeTypes)[type] ?? type,
            }]),
        {
          title: 'Trạng thái',
          dataIndex: 'isActive',
              ...
              render: (_: unknown, item: CatalogItem) => (
                <Space>
                  ...
                  <Popconfirm
                    ...
                    onConfirm={() => deleteMutation.mutate({ kind, id: item.id })}
                  >
                    <Button
                      type="text"
                      danger
        ...
        items={[
          {
            ...
            children: (
              <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                ...
                {table('province', provinces.data?.items ?? [], provinces.isLoading)}
              </Space>
            ),
          },
          {
            ...
            children: (
              <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                ...
                {table('district', districts.data?.items ?? [], districts.isLoading)}
              </Space>
            ),
          },
          {
            ...
            children: (
              <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                ...
                {table('commune', communes.data?.items ?? [], communes.isLoading)}
              </Space>
            ),
          },
        ]}
